...
export const ETHER_SYMBOL = "HYPE";
export const ETHER_NAME = "hype";

export const WRAPPED = "0x5555555555555555555555555555555555555555";
...
WOO_PP_QUOTE_TOKENS.set(WOO_PP_SOURCES[0], STABLE_TOKENS[0]);  // USDT0
